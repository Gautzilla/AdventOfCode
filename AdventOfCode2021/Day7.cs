...
namespace AdventOfCode2021
{
    class Day7
    {
        ...
        {
            //string path = @"D:\Documents Gauthier\Programmation\AdventOfCode2021\Day7\Exampleinput.txt";
            string path = @"D:\Documents Gauthier\Programmation\AdventOfCode2021\Day7\input.txt";
